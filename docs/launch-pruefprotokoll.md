...
⚠️⚠️ **INHALTLICHER WIDERSPRUCH, NICHT VON MIR KORRIGIERT — bitte entscheiden.**
...
Ich habe den Einleitungssatz **nicht angefasst** (bestehender Webtext). Zu klären:
entweder der Satz wird auf Bischberg geändert, oder der Meilenstein bleibt bei
Bamberg. Es ist die **einzige** Stelle im ganzen Projekt mit einer
Gründungsort-Aussage — die anderen 2016-Treffer sind das Jahr der
ISO-9001-Zertifizierung und davon unberührt.

---

## Noch offen (Blöcke D bis K)

Wird hier fortgeschrieben, sobald die Blöcke durch sind.

- D — Startseite im Menü, Google-Badge, Einsatzgebiete im Footer
